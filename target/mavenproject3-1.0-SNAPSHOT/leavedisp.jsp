<%-- 
    Document   : leavedisp
    Created on : 27-Jan-2022, 3:56:07 pm
    Author     : adiku
--%>
...
<html>
    ...
    try{  
        PreparedStatement ps=ct.prepareStatement("select fname,lname,username,no_of_days,start_date,leave_reason from leave where approved='N'");
